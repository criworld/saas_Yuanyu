<template>
	...
	>
		...
		<view class="mescroll-body-content mescroll-wxs-content" :style="{ transform: translateY, transition: transition }" :change:prop="wxsBiz.callObserver" :prop="callProp">
			...
			<view v-if="mescroll.optDown.use" class="mescroll-downwarp" :style="{'color':mescroll.optDown.textColor}">
			...
			<view v-if="mescroll.optUp.use && !isDownLoading && upLoadType!==3" class="mescroll-upwarp" :style="{'color':mescroll.optUp.textColor}">
